...
namespace AllegroGraphNetCoreClient.OpenRDF.Sail
{
    public static class Spec
    {
        ...
        /// <returns></returns>
        public static string Federate(List<string> stores)
        {
        ...
        /// <returns></returns>
        public static string GraphFilter(string store, List<string> graphs)
        {
            string asGraphResult;

            void AsGraph(object obj)
            {
                if (obj == null)
                {
                    asGraphResult = "null";
